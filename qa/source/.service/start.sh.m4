...
__service,worker1,worker --isotovideo '__workdir/os-autoinst/isotovideo' --host http://127.0.0.1:__port --instance 1 --apikey 1234567890ABCDEF --apisecret 1234567890ABCDEF,
__service,worker2,worker --isotovideo '__workdir/os-autoinst/isotovideo' --host http://127.0.0.1:__port --instance 2 --apikey 1234567890ABCDEF --apisecret 1234567890ABCDEF,
__service,worker3,worker --isotovideo '__workdir/os-autoinst/isotovideo' --host http://127.0.0.1:__port --instance 3 --apikey 1234567890ABCDEF --apisecret 1234567890ABCDEF,
openqa-__service daemon))

ifelse(__service,worker1,`',__service,worker2,`',__service,worker3,`',__service,gru,`',OPENQA_BASE_PORT=__port )__srcdir/script/CMD >> __workdir/__service/.cout 2>> __workdir/__service/.cerr &
pid=$!
